...
function agregarReservation() {
    ...
    if ($("#startDate").val().length == 0 || $("#devolutionDate").val().length == 0 || $("#status").val().length == 0) {
        ...
        $.ajax({
            ...
            url: "http://152.70.114.82:8080/api/Reservation/save",
...
function listarReservation() {
    $.ajax({
        url: "http://152.70.114.82:8080/api/Reservation/all",
...
function borrarReservation(idElemento) {
    ...
    $.ajax({
        dataType: 'json',
        data: dataToSend,
        url: "http://152.70.114.82:8080/api/Reservation/" + idElemento,
...
function cargarDatosReservation(id) {
    $.ajax({
        dataType: 'json',
        url: "http://152.70.114.82:8080/api/Reservation/" + id,
...
function actualizarReservation(idElemento) {
    ...
    if ($("#startDate").val().length == 0 || $("#devolutionDate").val().length == 0 || $("#status").val().length == 0) {
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url: "http://152.70.114.82:8080/api/Reservation/update",
