function autoInicioCategoria() {
    ...
    $.ajax({
        url: "http://152.70.114.82:8080/api/Category/all",
        type: "GET",
        datatype: "JSON",
...
function editarDatosFinca(id) {
    $.ajax({
        dataType: 'json',
        url: "http://152.70.114.82:8080/api/Farm/" + id,
...
function guardarInformacionFincas() {
    ...
    if ($("#Fname").val().length == 0 || $("#Faddress").val().length == 0 || $("#Fextension").val().length == 0 || $("#Fdescription").val().length == 0) {
        ...
        $.ajax({
            ...
            url: "http://152.70.114.82:8080/api/Farm/save",
...
function borrarInformacionFinca(idElemento) {
    ...
    $.ajax({
        dataType: 'json',
        data: dataToSend,
        url: "http://152.70.114.82:8080/api/Farm/" + idElemento,
...
function actualizarDatosFinca(idElemento) {
    ...
    if ($("#Fname").val().length == 0 || $("#Faddress").val().length == 0 || $("#Fextension").val().length == 0 || $("#Fdescription").val().length == 0) {
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url: "http://152.70.114.82:8080/api/Farm/update",
